...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `Ciee yang Jadian💖 Jangan lupa Donasi Ke *Jaka*🗿
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            case 'join': {
                if (!isCreator) throw mess.owner
                if (!text) throw 'Link Grup nya mana sayangg!'
                if (!isUrl(args[0]) && !args[0].includes('whatsapp.com')) throw 'Linknya Invalid sayang!'
                m.reply(mess.wait)
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'delete': case 'del': {
                ...
                if (!isBaileys) throw 'Pesannya Bukan dari gw "-_'
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                m.reply(`Tunggu Sayang Sedang Mengirim Ke ${anu.length} Grup Selesainya Cuma ${anu.length * 1.5} detik`)
                for (let i of anu) {
                    await sleep(1500)
                    let btn = [{
                                urlButton: {
                                    displayText: 'Grub Ofc CantikaBotz',
                                    url: 'https://chat.whatsapp.com/DFsUjv3ZU2BLxmRvGkUdiu'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Ayang gw',
                                    phoneNumber: '+6285785694474'
                                }
                            }, {
                                quickReplyButton: {
                                ...
                                quickReplyButton: {
                                    displayText: 'My love:v',
                                    id: 'owner'
                                }  
                            }, {
                                quickReplyButton: {
                                    displayText: 'Scriptnya',
                                    id: 'sc'
                                }
                            }]
...
⭔ Url : ${anu.url}`,
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) throw `Example : ${prefix + command} 6285785694474`
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
            ...
            case 'ping': case 'botstatus': case 'statusbot': {
                ...
                respon = `
Kecepatan Respon Saia ${latensi.toFixed(4)} _Second_ \n ${oldd - neww} _miliseconds_\n\nSaia Aktip Selama : ${runtime(process.uptime())}
...
Yang Dibuat Oleh Ayang Gw, Yg Bernama Jaka:v, Awokawok
Fiturnya Pengen Dibanyakin?/Ada Yg Error Awokawok Bilang Ama Ayang Gw Ntar Juga Diperbaiki.

❏ *Info My Lope:v*
> Name : *Jakaofc*
> Nomor : *https://wa.me/6285785694474*
> Umur : *16*
> Region : *Indonesia Yakali Prindapan*
> Hobyy : *Hmm Apa Ya*
> Made in : *Jawa Timur*
> Nama Asli : *Tebak Aja:v*
└───────⭓
~Silahkan Lihat Menu Dibawah Ya🗿^^~
┌──⭓ *Group Menu*
│
│⭔ ${prefix}linkgroup
...
│
└───────⭓
_Donasi Ngab Jangan Ngarep Free Mulu Dikira Gampang Buat Bot_`
                let btn = [{
                                urlButton: {
